...
Once we obtain the output of the predictor and the ones of the target network projection layer, they get normalized.

$$\hat{\mathcal{q}}_ \theta \leftarrow \mathcal{q}_ \theta / \lVert \mathcal{q}_ \theta \rVert \qquad (4)$$

$$\hat{\mathcal{z}}_ \xi \leftarrow \mathcal{z}_ \xi / \lVert \mathcal{z}_ \xi \rVert \qquad (5)$$

$$mathcal{L}_ BYOL = 2 - 2*(\hat{\mathcal{q}})$$
